...
const mealVariants: MealVariant[] = [
  // ===== PETIT-DÉJ =====
  // 4 variantes simples accessibles en supermarché FR. Aucune ne contient
  // de blancs d'œufs liquides (introuvables en grande surface en France).
  // Le skyr (Lidl, Carrefour…) ou les œufs entiers couvrent la protéine.
  {
    slot: "BREAKFAST",
    variantKey: "default",
    displayName: "Bowl skyr & avoine",
    description: "Zéro cuisson, 5 min chrono. Le plus simple : flocons + skyr + banane.",
    items: [
      { foodName: "Flocons d'avoine", quantity: 80 },
  ...
  {
    slot: "BREAKFAST",
    variantKey: "oeufs-avoine",
    displayName: "Œufs & avoine",
    description: "Le classique chaud. Porridge + œufs brouillés, 10 min.",
    items: [
  ...
  },
  {
    ...
    displayName: "Toast & œufs brouillés",
    description: "Petit-déj salé chaud. Pain complet, œufs brouillés, skyr à côté.",
    items: [
  ...
  {
    slot: "BREAKFAST",
    variantKey: "toast-jambon",
    displayName: "Toast jambon poulet & skyr",
    description: "Salé sans cuisson. 5 min chrono, idéal en cut (faible en lipides).",
    items: [
      { foodName: "Pain complet", quantity: 3 },
      { foodName: "Jambon de poulet maigre", quantity: 80 },
      { foodName: "Skyr / Fromage blanc 0%", quantity: 250 },
      { foodName: "Banane", quantity: 1 },
    ],
  },
